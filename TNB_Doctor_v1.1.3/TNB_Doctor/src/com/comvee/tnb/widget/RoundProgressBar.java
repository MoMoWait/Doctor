...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		roundWidth = mTypedArray.getDimension(R.styleable.RoundProgressBar_ProgressBarRoundWidth, 5);
...
//		Log.e("log", centre + "");
		...
		case FILL:{
			...
			paint.setMaskFilter( new EmbossMaskFilter(new float[] { 1.0F,
			 1.0F, 1.0F }, 0.3F, 6.0F, Math.max(1.0F,5 / 3.0F)));
