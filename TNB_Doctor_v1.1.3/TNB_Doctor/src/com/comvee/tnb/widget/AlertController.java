...
public class AlertController {
	...
	public static int m_MyAlertContentViewId=R.layout.alert_dialog; //默认的对话框布局ID
            ...
            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(
                            mContext, R.layout.select_dialog_multichoice, android.R.id.text1, mItems) {
                        @Override
