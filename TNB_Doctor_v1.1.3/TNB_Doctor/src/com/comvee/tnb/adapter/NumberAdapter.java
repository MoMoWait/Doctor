...
//
//		convertView = View.inflate(mContext, R.layout.health_number_item, null);
//
...
//			textView.setTextColor(mContext.getResources().getColor(R.color.calendar_bg_color));
...
//
//		int selectColor = mContext.getResources().getColor(R.color.calendar_bg_color);
...
////		if (null == mAapter)
////			mAapter = new NumberAdapter(getApplicationContext(), mMinValue, mMaxValue, 16);
////		mWheelView = (WheelView) findViewById(R.id.v_number_wheel);
////		mWheelView.setAdapter(mAapter);
////		// 默认值的位置
////		int defaultIndex = mDefaultValue - mMinValue;
////		mWheelView.setSelection(defaultIndex);
////		mAapter.setSeletedIndex(defaultIndex);
////		mWheelView.setOnItemSelectedListener(mAapter);
////
////		mFloatWheelView = (WheelView) findViewById(R.id.v_number_wheel_float);
////		if (isFloat) {
////			if (null == mFloatAdapter)
////				mFloatAdapter = new NumberAdapter(getApplicationContext(), 0, 9, 16);
////			mFloatWheelView.setAdapter(mFloatAdapter);
////
////			mFloatWheelView.setSelection(mDefaultFloatValue);
////			mFloatAdapter.setSeletedIndex(mDefaultFloatValue);
////			mFloatWheelView.setOnItemSelectedListener(mFloatAdapter);
////		} else {
////			findViewById(R.id.v_float).setVisibility(View.GONE);
////			mFloatWheelView.setVisibility(View.GONE);
////		}
//
//
//	}
