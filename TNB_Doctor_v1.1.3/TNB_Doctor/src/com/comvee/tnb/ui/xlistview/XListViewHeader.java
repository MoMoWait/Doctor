package com.comvee.tnb.ui.xlistview;
...
public class XListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.comvee_xlistview_header, null);
	...
	public void setState(int state) {
		...
		//refreshUpdatedAtValue();
		 mArrowImageView.setImageResource(R.drawable.xial_02);
		if (state == mState)
			return;
		...
		case STATE_SUCCESS:
			...
			mArrowImageView.setVisibility(View.VISIBLE);
			mHintTextView.setText(R.string.xlistview_header_last_time);
			
			 mArrowImageView.setImageResource(R.drawable.xial_04);
