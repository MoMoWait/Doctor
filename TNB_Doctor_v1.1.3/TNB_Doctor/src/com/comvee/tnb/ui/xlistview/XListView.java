...
//		mFooterView.setState(XListViewFooter.STATE_LOADING);
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (!mPullLoading && getFirstVisiblePosition() == 0 && (mHeaderView.getVisiableHeight() > 0 || deltaY > 0)) {
				...
				invokeOnScrolling();
			} else if (!mPullRefreshing && getLastVisiblePosition() == mTotalItemCount - 1 && (mFooterView.getBottomMargin() > 0 || deltaY < 0)) {
	...
	/*
	 * public void hideFootView() { mFooterView.hide(); } public void
	 * showFootView() { mFooterView.show(); }
	 */
	/**
