...
public class TosGallery extends TosAbsSpinner implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
	...
	private ScrollListener scrollListner;
	...
	public TosGallery(Context context, AttributeSet attrs, int defStyle) {
		...
		int animationDuration = a.getInt(R.styleable.Gallery_myanimationDuration, -1);
	...
	protected boolean getChildStaticTransformation(View child, Transformation t) {
		...
		Log(" getChildStaticTransformation   mSelectedPosition =  " + mSelectedPosition + "   mFirstPosition = " + mFirstPosition
	...
	private void fillToGalleryTop() {
		...
		while (curRightEdge > galleryTop && curPosition >= 0) {
			prevIterationView = makeAndAddViewVertical(curPosition, curPosition - mSelectedPosition, curRightEdge, false);
	...
	public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
		...
		if (scrollListner != null) {
			scrollListner.scroll(e1, e2, distanceX, distanceY);
		}
...
//			Log.v(TAG, String.valueOf(e2.getX() - e1.getX()));
	...
	private void updateSelectedItemMetadata() {
		...
		Log(" updateSelectedItemMetadata   mSelectedPosition =  " + mSelectedPosition + "   mFirstPosition = " + mFirstPosition);
	 ...
	 * @author valexhuang
	 * @param scrollListner
	 *            the scrollListner to set
	 */
	public void setScrollListner(ScrollListener scrollListner) {
